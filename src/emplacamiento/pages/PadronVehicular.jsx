...
import { AutoridadFiscal } from "../tabs/padronVehicular/AutoridadFiscal";
...
const tabComponents = [AutoridadFiscal];

export const PadronVehicular = () => {
  ...
  const [sharedDataVehiculo, setSharedDataVehiculo] = useState({
    // rfc: "",
    // curp: "",
    // nombreContribuyente: "",
    ...
    <>
      <div className="m-4 flex flex-col gap-4">
        ...
        <h2 className="font-cascadiaMono text-sefi-letter  text-4xl">
          Formulario para Movimientos al Padron Vehícular
        </h2>
      </div>
