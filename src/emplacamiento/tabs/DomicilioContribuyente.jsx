...
export const DomicilioContribuyente = ({ sharedData, setSharedData }) => {
  return (
    <>
      <form className="gap-4 flex flex-col">
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <Label htmlFor="numExterior" className="block text-sm font-medium">
              Número Exterior
            </Label>
            <Input
              id="numExterior"
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <Label htmlFor="numInterior" className="block text-sm font-medium">
              Número Interior
            </Label>
            <Input
              id="numInterior"
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <Label htmlFor="geoLongitud" className="block text-sm font-medium">
              Longitud
            </Label>
            <Input
              id="geoLongitud"
